...
void benchmark(bool all_sizes = false)
{
    ...
    else
    {
        ...
        bbpw.assign({129, 122, 63, 35, 35, 17, 17, 15, 15, 15, 13, 13, 12, 12, 12, 12, 11, 11, 11, 10, 10, 10, 10, 10});
        fbpw.assign({4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4});
        cbpw.assign({1, 3, 5, 6, 6, 9, 9, 10, 10, 10, 11, 11, 11, 12, 12, 12, 12, 12, 12, 12, 13, 13, 13, 13});
        bbdw.assign({129, 92, 52, 30, 30, 15, 15, 13, 13, 13, 11, 11, 11, 10, 10, 10, 10, 10, 10, 9, 9, 9, 9, 9});
        cbdw.assign({4, 3, 3, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2});
        ...
        bbpw.assign({129, 129, 129, 69, 69, 34, 34, 29, 29, 29, 24, 24, 22, 21, 21, 21, 19, 19, 19, 17, 16, 16, 16, 16});
        wbpw.assign({1, 4, 8, 11, 11, 16, 16, 17, 17, 17, 19, 19, 20, 21, 21, 21, 22, 22, 22, 23, 23, 23, 24, 24});
        hbpw.assign({1, 4, 8, 11, 11, 16, 16, 17, 17, 17, 19, 19, 20, 21, 21, 21, 22, 22, 22, 23, 23, 23, 24, 24});
        hbdw.assign({1, 4, 8, 16, 16, 48, 49, 64, 64, 65, 91, 91, 91, 91, 91, 91, 91, 91, 91, 91, 91, 91, 91, 91});
        wbdw.assign({1, 4, 8, 16, 16, 48, 49, 64, 64, 65, 91, 91, 91, 91, 91, 91, 91, 91, 91, 91, 91, 91, 91, 91});
    }
